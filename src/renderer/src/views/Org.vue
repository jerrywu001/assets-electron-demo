...
<template>
  ...
  <div style="display: flex; gap: 20px; align-items: flex-start;">
    ...
    <el-card v-if="selectedNode" shadow="never" style="flex: 1;">
      <template #header>
        <div style="display: flex; justify-content: space-between; align-items: center;">
          <span>{{ selectedNode.name }}</span>
          <div>
            <el-button size="small" @click="renameDept">
              重命名
            </el-button>
            <el-button size="small" @click="editRemark">
              备注
            </el-button>
            <el-button size="small" @click="moveDept">
              更换上级
            </el-button>
            <el-button size="small" type="danger" @click="removeDept">
              删除
            </el-button>
          </div>
        </div>
      ...
      <el-descriptions :column="2" border size="small" style="margin-bottom: 16px;">
        ...
        <el-descriptions-item label="总人数（含下级）">
          {{ totalEmployees(selectedNode) }} 人
        </el-descriptions-item>
      ...
      <h4 style="margin: 0 0 8px;">
        部门员工（含下级部门，共 {{ employees.length }} 人）
      </h4>
      <div class="data-table-wrap">
        <el-table v-loading="loadingEmps" height="100%" :data="employees" border size="small" empty-text="该部门暂无员工">
  ...
  <el-dialog v-model="moveDialog" title="更换上级部门" width="420px">
    ...
    <template #footer>
      <el-button @click="moveDialog = false">
        取消
      </el-button>
