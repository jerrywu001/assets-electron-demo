...
export const IpcChannel = {
  ...
  ,CategoryList: 'category:list', CategoryDeviceTypes: 'category:device-types', CategoryCreate: 'category:create', CategoryUpdate: 'category:update', CategoryDelete: 'category:delete', CategorySetDevices: 'category:set-devices', DeviceTypeCreate: 'device-type:create', DeviceTypeUpdate: 'device-type:update', DeviceTypeDelete: 'device-type:delete'
} as const
...
export interface AssetApi {
  ...
  createDeviceType(input: { categoryId: number; name: string }): Promise<number>
